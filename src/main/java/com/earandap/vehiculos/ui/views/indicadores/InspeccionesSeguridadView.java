...
@SpringComponent
@UIScope
@SpringView(name = InspeccionesSeguridadView.VIEW_NAME)
public class InspeccionesSeguridadView extends SecureView implements EditButtonValueRenderer.RendererClickListener {

    public static final String VIEW_NAME = "inspecciones-seguridad";
    ...
    public void init() {
        bar = new MenuBar();
        content = new PortletView("Inspecciones Seguridad", FontAwesome.VIDEO_CAMERA, bar);
        ...
        Label lblDescrip = new Label("Vehículos con Mtto. Preventivo / Inspecciones con Hallazgos");
    ...
    private void actualizarGrid() {
        try {
            ...
            elems = obj.consultarInspecionesSeguridad(fechaInicialField.getValue(), fechaFinalField.getValue());
            indicadorGrid.actualizarContenido(new String[]{"Total Vehículos", "Mttos. Preventivos (%)", "Inspecciones", "Con Hallazgos (%)"}, elems);
        } catch (Exception e) {
