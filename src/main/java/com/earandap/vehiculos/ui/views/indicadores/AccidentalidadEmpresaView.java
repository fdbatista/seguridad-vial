...
@SpringComponent
@UIScope
@SpringView(name = AccidentalidadEmpresaView.VIEW_NAME)
public class AccidentalidadEmpresaView extends SecureView implements EditButtonValueRenderer.RendererClickListener {

    public static final String VIEW_NAME = "accidentalidad";
    ...
    public void init() {
        bar = new MenuBar();
        content = new PortletView("Accidentalidad", FontAwesome.AMBULANCE, bar);
        ...
        /*Label lblDescrip = new Label("Accidentes / Empleados Lesionados / Conductores Lesionados / Mortalidad / P\u00E9rdidas");
        l2.addComponent(lblDescrip);*/
    ...
    private void actualizarGrid() {
        try {
            ...
            elems = obj.consultarAccidentalidadEmpresa(fechaInicialField.getValue(), fechaFinalField.getValue());
            indicadorGrid.actualizarContenido(new String[]{"Accidentes", "Empleados Lesionados (%)", "Conductores Lesionados (%)", "Mortalidad (%)", "P\u00E9rdidas"}, elems);
        } catch (Exception e) {
