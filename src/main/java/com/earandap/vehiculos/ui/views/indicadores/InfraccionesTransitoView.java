...
@SpringComponent
@UIScope
@SpringView(name = InfraccionesTransitoView.VIEW_NAME)
public class InfraccionesTransitoView extends SecureView implements EditButtonValueRenderer.RendererClickListener {

    public static final String VIEW_NAME = "infracciones-transito";
    ...
    public void init() {
        bar = new MenuBar();
        content = new PortletView("Infracciones de Tr\u00e1nsito", FontAwesome.EXCLAMATION_TRIANGLE, bar);
    ...
    private void actualizarGrid() {
        try {
            ...
            elems = obj.consultarInfracciones(fechaInicialField.getValue(), fechaFinalField.getValue());
            indicadorGrid.actualizarContenido(new String[]{"Total de Conductores", "Infractores (%)", "Infracciones", "Canceladas (%)"}, elems);
        } catch (Exception e) {
