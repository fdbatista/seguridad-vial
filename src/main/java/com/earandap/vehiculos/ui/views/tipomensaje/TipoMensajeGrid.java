...
@SpringComponent
@UIScope
public class TipoMensajeGrid extends Grid {

    protected Container container;

    public static final String NUEVO_TIPOMENSAJE = "NUEVO-TIPOMENSAJE";
    public static final String ELIMINADO_TIPOMENSAJE = "ELIMINADO-TIPOMENSAJE";
    ...
    @EventBusListenerTopic(topic = TipoMensajeGrid.NUEVO_TIPOMENSAJE)
    @EventBusListenerMethod
    public void nuevaNotificacionListener(TipoMensaje tipoMensaje) {
        container.removeItem(tipoMensaje.getId());
        container.addBean(tipoMensaje);
    }

    @EventBusListenerTopic(topic = TipoMensajeGrid.ELIMINADO_TIPOMENSAJE)
    @EventBusListenerMethod
    ...
    public void setData(List<TipoMensaje> tipoMensajes) {
        container.removeAllItems();
        container.addAll(tipoMensajes);
    }
    ...
    public static class Container extends BeanContainer<Long, TipoMensaje> {

        public Container() {
            super(TipoMensaje.class);
            setBeanIdResolver(tipoMensaje -> tipoMensaje.getId());
        }
    }
}
