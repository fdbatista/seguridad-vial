...
@SpringComponent
@UIScope
@SpringView(name = CapacitacionesSeguridadVialView.VIEW_NAME)
public class CapacitacionesSeguridadVialView extends SecureView implements EditButtonValueRenderer.RendererClickListener {

    public static final String VIEW_NAME = "capacitaciones-seg-vial";
    ...
    public void init() {
        bar = new MenuBar();
        content = new PortletView("Capacitaciones Seg. Vial", FontAwesome.GRADUATION_CAP, bar);
    ...
    private void actualizarGrid() {
        try {
            ...
            elems = obj.consultarCapacitacionesSegVial(fechaInicialField.getValue(), fechaFinalField.getValue());
            indicadorGrid.actualizarContenido(new String[]{"Programadas", "Realizadas (%)", "Evaluados", "Con +70 Puntos (%)"}, elems);
        } catch (Exception e) {
